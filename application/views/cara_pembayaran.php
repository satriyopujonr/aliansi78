            ...
            <div class="row">
              ...
              <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                      ...
                      <li class="active"><a href="<?= base_url()?>Home/cara">Cara Pembayaran</a></li>
                  </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="" align="center">
                          ...
                          <p> Setelah melakukan pembelian, silahkan transfer uang sesuai nominal harga ke nomer rekening U store </p><br>
                            <H4> Nama Bank : BCA </H4><br>
                            <h4>Nomer rekening : 00976374974 </h4><br>
                            <h4>Atas Nama : U store </h4><br><br><br>
