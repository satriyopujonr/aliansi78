		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Kategori berita</a></li>
                        <li class="active">Edit Kategori berita</li>
                    </ol>
                </section>
                	...
                	<div class="alert alert-block alert-info">
                    	<button type="button" class="close" data-dissmis="alert">
                            ...
                            <strong class="green">
                                ...
                                <form role="form" action="<?php echo base_url(); ?>C_kategori_berita/c_u_kategori_berita/update" method="post" enctype="multipart/form-data" >
                                	<div class=box-body">
                                    <div class=box-body">
